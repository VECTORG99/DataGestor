...
def sample_raw_df() -> pd.DataFrame:
    return pd.DataFrame({
        "borough": ["City of London", "Westminster", None, "Kensington And Chelsea", "Camden", "Westminster"],
        "major_category": ["Theft and Handling", "Violence Against the Person", "Burglary", None, "Theft and Handling", "Theft and Handling"],
        "minor_category": ["Pickpocketing", "Assault", None, "Burglary", "Shoplifting", "Pickpocketing"],
        "value": [10, 5, -3, 15, 0, 10],
        "year": [2016, 2015, 2020, 2017, 2016, 2016],
        "month": [1, 13, 6, 8, 1, 1],
        "lsoa_code": ["E01000001", "E01000002", "E01000003", "E01000004", "E01000001", "E01000001"],
    })
...
def sample_clean_df() -> pd.DataFrame:
    return pd.DataFrame({
        ...
        "major_category": pd.array(["Theft and Handling", "Violence Against the Person", "Theft and Handling"], dtype="string"),
...
def sample_clean_df_with_duplicates() -> pd.DataFrame:
    return pd.DataFrame({
        ...
        "major_category": ["Theft and Handling", "Theft and Handling", "Violence Against the Person"],
